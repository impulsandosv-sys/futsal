...
- **Modelo legado (Fase 4A):** RegistroMenstrual contaba con
echa_inicio, impacto_percibido, comentario y
ota_ajuste.
- **Modelo nuevo (Fase 4B):** Se amplía la interfaz de RegistroMenstrual añadiendo ccion_ajuste (una enumeración estructurada) y
echa_decision (la fecha en que el profesional toma la decisión).
...
- [x] Confirmar exclusión correcta de \
egistro_menstrual\, \ccion_ajuste\ y notas en exportaciones (staff PDF, DTO ordinario).
