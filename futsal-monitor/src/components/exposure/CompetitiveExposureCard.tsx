...
export function CompetitiveExposureCard({ registros, fechaCorteISO, modo = "completo" }: Props) {
  ...
  const renderCalidadTooltip = () => (
    <div className="relative group/calidad w-fit">
      ...
      <div
        ...
        role="tooltip"
        className="pointer-events-none absolute bottom-full mb-1 left-1/2 -translate-x-1/2 hidden group-hover/calidad:block peer-focus:block w-48 p-2 bg-surface-800 text-white text-[10px] rounded shadow-lg text-center z-50"
      >
        {tooltipCalidad()}
      </div>
    </div>
  ...
  const mostrarMetricasInterpretables =
    exp.calidadDato !== "sin_registros_competitivos" &&
    exp.calidadDato !== "insuficiente"
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        {mostrarMetricasInterpretables && exp.convocadaSinMinutos28d > 0 && (
          <div className="flex items-center justify-between">
        ...
        {mostrarMetricasInterpretables && exp.porcentajeExposicion7d !== null ? (
        ...
        {mostrarMetricasInterpretables && exp.referenciaSemanal28d !== null ? (
          <div className="flex items-center justify-between">
        ...
        {mostrarMetricasInterpretables && exp.ratioCambioExposicion !== null ? (
